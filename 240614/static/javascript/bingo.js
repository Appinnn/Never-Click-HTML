//전역 변수
let endCount = 0; //완성빙고가 몇개나 완성됐는지. (초기값)
...
$(function() //브라우저에 모두 표시되면 실행 되는 함수 - window.onload
{
    ...
    //     for ( var i in tdclick )   //배열만 사용 가능한 for문
    //     {
...
function start()
{
    $('.num').click(bingoCheck); //숫자가 표시된 td를 클릭하면 bingoCheck함수 실행 선언
    //빙고 게임을 위한 숫자 배치
    //빙고 시작버튼 감추기
    //빙고 진행 상황 보이기
...
/* 
    ...
    빙고가 5줄 완성되면 게임 끝나게 하기 - 진행시간 멈추기 + 더이상 클릭 이벤트 실행x
